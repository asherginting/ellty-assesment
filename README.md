...
First Test Assigment - Frontend Developer


[![img](https://i.ibb.co.com/Q3QZkNLQ/image.png)](#)
...
1. Clone this repo
```
git clone git@github.com:asherginting/ellty-assesment.git
```
...
4. Done, ```pnpm run dev``` to run the project
