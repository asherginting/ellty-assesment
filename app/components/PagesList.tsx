...
export default function PagesDropdown() {
  ...
  return (
    <section className="w-[370px] rounded-md bg-white border border-gray-150 shadow-card py-2.5 px-[15px]">
      ...
      <div className="space-y-1 max-h-[164px] overflow-y-auto scrollbar-hide">
        {PageData.map((page) => (
          <div
            key={page}
